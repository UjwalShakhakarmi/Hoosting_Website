...
import { FandQ, Button3, Posts, BannerBtn } from "../component";
import Benefits from "../component/Benefits.jsx";
import styles from "../style.js";
import Slider from "react-slick";
import { IoCheckmarkCircle } from "react-icons/io5";
import Card from "../component/card/cardVPS.jsx";
import CardHighlight from "../component/card/cardHighVPS.jsx";
import { IoCheckmark } from "react-icons/io5";
import { Background3, WordPressImg } from "../assets";
import { Link } from "react-router-dom";
import { useTheme } from "../Context/ThemeContext.jsx";
import OSsetup from "../component/OSsetup.jsx";
...
const carddata = [
  {
    ...
    ActualPrice: 3000,
    subHead: "Dedicated IP",
    subHead_sub: "",
    time: "mon",
    subdomain: "5",
    ram: "2",
    core: "1",
    link: "https://client.hoostly.com/index.php?rp=/store/vps/vps-server-i",
  },
  {
    head: "VPS Server III",
    ...
    ram: "8",
    core: "4",
    link: "https://client.hoostly.com/index.php?rp=/store/vps/vps-server-ii",
  },
];
const cardhighlightdata = {
  ...
  ram: "4",
  core: "2",
  link: "https://client.hoostly.com/index.php?rp=/store/vps/vps-server-iii",
};
const FandQdata = [
  {
    id: 1,
...
const VPSHosting = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cheapest VPS Server in Nepal NVME SSD Cloud VPS Hosting</title>
        <meta
          name="description"
          content="Discover the Cheapest VPS Hosting in Nepal! Experience lightning-fast NVME SSD Cloud VPS Hosting with top-notch performance and reliability."
        />
      </Helmet>
            ...
            <div className="flex flex-col justify-between items-left w-full pt-[5rem] lg:pt-[1rem] text-white">
              ...
              <div className="lg:w-1/2 py-5">
                <div className="grid grid-cols-2 gap-12">
                  <Link
                    to={"https://client.hoostly.com/index.php?rp=/store/vps"}
                  >
                  ...
                  <div className="w-full md:w-3/4 lg:w-2/3">
                    <div className="text-center mb-9">
                      <h2 className="text-3xl font-bold mb-2 text-secondary">
                        Reliable VPS hosting plans for your sites
                      </h2>
