...
import { WordPressImg, WImg1 } from "../assets";
...
const carddata = [
  {
    head: "Wordpress Starter",
    desc: "Empower your ventures the perfect WordPress hosting kick-off",
    ...
    sql: "5",
    core: "1",
    link: "https://client.hoostly.com/index.php?rp=/store/wordpress-hosting/wordpress-starter",
  },
  {
    head: "Wordpress Business",
    ...
    sql: "15",
    core: "2",
    link: "https://client.hoostly.com/index.php?rp=/store/wordpress-hosting/wordpress-business",
  },
];
const cardhighlightdata = {
  ...
  sql: "10",
  core: "2",
  link: "https://client.hoostly.com/index.php?rp=/store/wordpress-hosting/wordpress-pro",
};
const FandQdata = [
  {
    id: 1,
    ...
    answer:
      "More than 30% of the internet is powered by WordPress, an open source content management system (CMS). For both novice and experienced users, WordPress makes it simple to develop, edit, and manage websites. WordPress is always being enhanced and developed by a community of international developers to give its users the best functionality and performance. WordPress is becoming the go-to platform for building and managing websites worldwide for both novice and experienced users thanks to its open source philosophy. Whether you want to create an e-commerce website or launch a blog, WordPress provides all the resources and tools you need to turn your website from a mere concept into a reality online.",
  },
  {
    id: 2,
  ...
  {
    id: 4,
    question: "How to choose best WordPress Hosting plans?",
    answer: `There are several points to consider before choosing the right WordPress hosting plan for your website, some of these important points to consider, include:
...
const WordPressHosting = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          WordPress Hosting - Hoostly | Best Web Hosting in Nepal | Cloud VPS
        </title>
        <meta
          name="description"
      ...
      <div className="w-full overflow-hidden relative">
            ...
            <div className="flex flex-col justify-between items-left w-full pt-[5rem] lg:pt-[1rem] text-white">
              ...
              <div className="lg:w-1/2 py-5">
                <div className="grid grid-cols-2 gap-12">
                  <Link to="https://client.hoostly.com/index.php?rp=/store/wordpress-hosting">
                  ...
                  <div className="w-full md:w-3/4 lg:w-2/3">
                    <div className="text-center mb-9">
                      <h2 className="text-3xl font-bold mb-2 text-secondary">
                        Reliable wordPress hosting plans for your sites
                      </h2>
            ...
            <div className="grid sm:grid-cols-2 lg:py-12 py-6 ">
              <div className=" lg:pr-[9rem]">
                ...
                <p className="text-secondary font-light pt-10">
                  Start by choosing a server location that is nearest to your
                  clients. For example, if the majority of your consumers are
                  situated in India, you should choose a data center located in
                  or adjacent to India for faster website load time.
                  <br />
                  <p className="pt-4">
                    We pride ourselves on delivering a seamless online
                    experience for our customers. With our state-of-the-art
                    infrastructure and 100% SSD storage, your website or
                    application will load swiftly, ensuring optimal user
                    satisfaction. Our VPS servers are not only fast and stable
                    but also offer the{" "}
                    <flexibility className="la"></flexibility>
                  </p>
                  <br />{" "}
                </p>
              </div>
              <div className="relative">
                ...
                <img src={WImg1} className=" mx-auto relative " />
              </div>
            </div>
            <div className="grid sm:grid-cols-2 lg:py-12 py-6">
              <div className="relative">
        ...
        <div className="py-12 ">
          ...
          <div
            className={`${styles.paddingX} ${styles.flexCenter} border-b border-gray-700`}
          >
            <div className={`${styles.boxWidth} `}>
              <ul className="grid grid-cols-2 lg:grid-cols-4 grid-flow-row lg:py-9 py-6 text-secondary text-[14px]">
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark />
                  <p className="mx-1">24/7/365 Support</p>
                </li>
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark /> <p className="mx-1">WordPress Optimized</p>
                </li>
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark /> <p className="mx-1">WordPress Staging Tool</p>
                </li>
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark />{" "}
                  <p className="mx-1">One-click Automatic Install</p>
                </li>
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark /> <p className="mx-1">Unlimited Bandwidth</p>
                </li>
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark /> <p className="mx-1">Free Backups</p>
                </li>
                <li className="flex items-center lg:py-2 py-0.5">
                  <IoCheckmark /> <p className="mx-1">Free Backups</p>
                </li>
