...
const carddata = [
  {
    head: "Python Hosting",
    desc: "Empower your ventures the perfect Python hosting kick-off",
    DiscountedPrice: 1999,
    ActualPrice: 3999,
    subHead: "1 python App",
    unlimited: "",
    un_sub: "",
    subdomain: "5",
    subHead_sub: "Website",
    ...
    ram: "2",
    core: "1",
    link: "https://client.hoostly.com/index.php?rp=/store/python-hosting/single-web-hosting",
  },
  {
    head: "Cloud Hosting",
    ...
    storage: "Unlimited",
    sql: "15",
    link: "https://client.hoostly.com/index.php?rp=/store/python-hosting/corporate-hosting",
  },
];
const cardhighlightdata = {
  ...
  sql: "10",
  core: "2",
  link: "https://client.hoostly.com/index.php?rp=/store/python-hosting/developer-hosting",
};
const FandQdata = [
  {
    id: 1,
    question: "What is Python hosting?",
    answer:
      "Python hosting refers to the service of hosting and deploying Python applications on servers that are specifically configured to support Python programming language. It provides a platform for running Python-based web applications, scripts, and other software.",
  },
  {
    id: 2,
    question: "Why do I need Python hosting?",
    answer:
      "Python hosting is essential for deploying and running Python applications on the web. It ensures that your Python code can be executed on a server, making your application accessible to users worldwide.",
  },
  {
    id: 3,
    question: "What features should I look for in a Python hosting provider?",
    answer:
      "When choosing a Python hosting provider, consider factors such as server reliability, performance, scalability, version compatibility, ease of deployment, and support for any specific frameworks or libraries your application may use (e.g., Django or Flask).",
  },
  {
    id: 4,
    question: " Can I host different versions of Python on the same server?",
    answer:
      "Yes, many hosting providers allow you to choose the version of Python you want to use for your application. Ensure that the hosting service supports the Python version required by your application.",
  },
  {
    id: 5,
    question: "How do I deploy my Python application to the hosting server?",
    answer:
      "Deployment processes may vary, but commonly, you'll upload your code to the server, set up any necessary dependencies, configure environment variables, and start your application. Many hosting providers offer documentation or tutorials to guide you through the deployment process.",
  },
  {
    id: 6,
    question: "Is it possible to scale my Python application as it grows?",
    answer:
      "Yes, scalability is an important consideration. Choose a hosting provider that offers scalable solutions, allowing you to adjust resources (like CPU, memory, and storage) based on the changing needs of your application.",
  },
];
...
const PythonHosting = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Python Hosting - Hoostly | Best Web Hosting in Nepal | Python VPS
        </title>
        <meta
          name="description"
            ...
            <div className="flex flex-col justify-between items-left w-full pt-[5rem] lg:pt-[1rem] text-white">
              ...
              <div className="lg:w-1/2 py-5">
                <div className="grid grid-cols-2 gap-12">
                  <Link to="https://client.hoostly.com/index.php?rp=/store/python-hosting">
                  ...
                  <div className="w-full md:w-3/4 lg:w-2/3">
                    <div className="text-center mb-9">
                      <h2 className="text-3xl font-bold mb-2 text-secondary">
                        Reliable Python hosting plans for your sites
                      </h2>
