...
import { Background1, WordPressImg, SIMG1 } from "../assets";
...
const carddata = [
  {
    head: "Single Web Hosting",
    desc: "Empower your ventures the perfect Web hosting kick-off",
    ...
    ram: "1",
    core: "1",
    link: "https://client.hoostly.com/index.php?rp=/store/shared-hosting/single-web-hosting",
  },
  {
    head: "Business Web Hosting",
    ...
    ram: "2",
    core: "1",
    link: "https://client.hoostly.com/index.php?rp=/store/web-hosting/business-web-hosting",
  },
];
const cardhighlightdata = {
  head: "Premium Web Hosting",
  desc: "Empower your ventures the perfect Web hosting kick-off",
  ...
  ram: "2",
  core: "1",
  link: "https://client.hoostly.com/index.php?rp=/store/web-hosting/premium-web-hosting",
};
const FandQdata = [
  {
    id: 1,
...
const SharedHosting = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Shared Hosting - Hoostly | Best Web Hosting in Nepal | Shared VPS
        </title>
        <meta
          name="description"
          content="Hoostly Best Web Hosting In Nepal provides affordable .com domain &amp; Shared Hosting | WordPress Hosting | VPS Server | Developer Hosting | Reseller Hosting | Python VPS"
        ></meta>
      </Helmet>
          ...
          <div className={`lg:px-[120px] px-5 lg:w-4/6`}>
            <div className="flex flex-col justify-between items-left w-full pt-[5rem] lg:pt-[1rem] text-white">
              ...
              <p className="font-light py-3">
                Take your website to the next level with our LiteSpeed Shared
                Hosting plans and experience our 5x faster loading times than
                competing services. our Shared hosting solutions are precisely
                built to maximize speed and performance.
              </p>
                  ...
                  <div className="w-full md:w-3/4 lg:w-2/3">
                    <div className="text-center mb-9">
                      <h2 className="text-3xl font-bold mb-2 text-secondary">
                        Reliable Shared hosting plans for your sites
                      </h2>
        ...
        <div className={`${styles.paddingX} ${styles.flexCenter}`}>
          <div className={`${styles.boxWidth} `}>
            <div className="grid sm:grid-cols-2 lg:py-12 py-6 ">
              <div className=" lg:pr-[5rem]">
                <h1 className="text-secondary text-[25px] pt-[50px] font-bold">
                  Reliable Shared Hosting
                </h1>
                <p className="text-secondary font-light pt-7">
                  Shared Hosting is a cost-effective web hosting solution where
                  multiple websites share the resources of a single server. This
                  type of hosting is perfect for small to medium-sized websites,
                  blogs, and startups looking to establish an online presence
                  without the complexities of server management. While resources
                  are shared among users, reputable shared hosting providers
                  ensure consistent performance, security measures, and customer
                  support.
                  <br />{" "}
                </p>
              </div>
              <div className="relative">
                ...
                <img src={SIMG1} className="w-1/2 mx-auto relative " />
              </div>
            </div>
            {/* <div className="grid sm:grid-cols-2 lg:py-12 py-6">
            <div className="relative">
