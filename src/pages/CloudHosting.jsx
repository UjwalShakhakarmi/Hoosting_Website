...
import { Background5, WordPressImg } from "../assets";
...
const carddata = [
  {
    head: "Cloud Starter",
    desc: "Empower your ventures the perfect Cloud hosting kick-off",
...
const FandQdata = [
  ...
  {
    id: 2,
    question: "Do I Need Cloud Hosting ?",
    answer: `That depends on what you are trying to accomplish.
  ...
  {
    id: 3,
    question: "Will The Cloud Host My Website ?",
    answer: `There is not one cloud. In fact, "the cloud" doesn't really exist — it isn't a thing, but rather a type of thing, a way of doing something.
    There are many different "clouds," run by many different web infrastructure companies. You can even set up your own cloud on your own server.
  ...
  {
    id: 4,
    question: "How to Host Website in the Cloud ?",
    answer: `From a user perspective, a cloud-hosted website isn't very much different than a conventionally-hosted VPS hosting plan, or even a shared hosting plan.
...
const CloudHosting = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Cloud Hosting - Hoostly | Best Web Hosting in Nepal | Cloud VPS
        </title>
        <meta
          name="description"
          ...
          <div className={`lg:px-[120px] px-5 lg:w-4/6`}>
            <div className="flex flex-col justify-between items-left w-full pt-[5rem] lg:pt-[1rem] text-white">
              ...
              <p className="font-light py-3">
                Take your website to the next level with our LiteSpeed Cloud
                  ...
                  <div className="w-full md:w-3/4 lg:w-2/3">
                    <div className="text-center mb-9">
                      <h2 className="text-3xl font-bold mb-2 text-secondary">
                        Reliable Cloud hosting plans for your sites
                      </h2>
